...
struct PointerDisplayStrings {
    ...
    static func localized(_ language: AppLanguage) -> PointerDisplayStrings {
        ...
        case .zhHans: return .init(title: "将鼠标移到下一台显示器", caption: "将鼠标移到下一台显示器的中央。")
        case .zhTW: return .init(title: "將滑鼠移到下一台顯示器", caption: "將滑鼠移到下一台顯示器的中央。")
        case .zhHK: return .init(title: "將滑鼠移到下一部顯示器", caption: "將滑鼠移到下一部顯示器的中央。")
        }
    }
}
